...
adapter_path = f"output/final_2/rplan{room_number}_2_70B_r64_a128_all"            
merged_model_path = f"models/final_2/rplan{room_number}_r64_a128-Llama-3.3-70B-Instruct"
