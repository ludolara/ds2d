...
def parse_arguments():
    ...
    parser.add_argument("--lora_adapter_path", type=str, default="output/rplan_10/")
    parser.add_argument("--test_split", type=str, default="test")
    parser.add_argument("--test_range", type=str, default=None, help="Specify range of test examples to use (e.g., '1,100' for the first 100 samples)")
    parser.add_argument("--max_new_tokens", type=int, default=2048)
    parser.add_argument("--batch_size", type=int, default=8)
    parser.add_argument("--device", type=str, default="cuda")
    parser.add_argument("--output_dir", type=str, default="results_feedback/generations/rplan/full_prompt", help="Directory to store the generated outputs")
