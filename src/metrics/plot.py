...
RENAME_VARIABLES = {
        ...
        'polygon_overlap_percentage_self_consistency': 'P. % Overlap (SC)',
...
CATEGORIES = ['json_file_consistency', 'total_area_self_consistency', 'polygon_overlap_count_self_consistency', 'polygon_overlap_percentage_self_consistency', 
