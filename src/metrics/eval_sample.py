from src.metrics.process_dataset import Floorplan, FloorplansAndPrompt
...
class MetricSummaries:
    ...
    polygon_overlap_percentage_self_consistency: float=None
...
class MetricResults:
    ...
    polygon_overlap_percentage_self_consistency: List[float]=None
