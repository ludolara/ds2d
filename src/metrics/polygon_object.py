...
#     zp_min = min(p1['y'],p2['y'])
#     zp_max = max(p1['y'],p2['y'])
#     zq_min = min(q1['y'],q2['y'])
#     zq_max = max(q1['y'],q2['y'])
    ...
    def get_sorted_vertices(self):
        def get_midpoint(vertices):
            ...
            for vertex in vertices:
                ...
                min_y, max_y = min(min_y, vertex['y']), max(max_y, vertex['y'])
        ...
        def get_slope_from_mid_point(vertices):
            ...
            ret = []
            for vertex in vertices:
                ret.append((vertex, math.atan2(vertex['x'] - mid_x, vertex['y'] - mid_z)))
