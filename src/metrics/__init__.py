class Metrics:
    ...
    def __init__(self, metric_names='all'):
        ...
        if 'polygon_overlap_percentage_self_consistency' in metric_names or metric_names == 'all':
            from .self_consistency import metric_polygon_overlap_percentage_self_consistency
            self.metric_lookup['polygon_overlap_percentage_self_consistency'] = metric_polygon_overlap_percentage_self_consistency
